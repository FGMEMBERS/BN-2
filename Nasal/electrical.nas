...
#    append(output_list,"landing-lights");
    append(switch_list,"controls/lighting/landing-light-left");
    append(output_list,"landing-light-left");
    append(switch_list,"controls/lighting/landing-light-right");
    append(output_list,"landing-light-right");
    append(switch_list,"controls/lighting/beacon");
    append(output_list,"beacon-base");
